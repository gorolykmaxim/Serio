...
TEST(WatchProgressTest, shouldBeCompleteAfter90Percent) {
    EXPECT_TRUE(serio::core::WatchProgress(90).isComplete());
    EXPECT_FALSE(serio::core::WatchProgress(89.9).isComplete());
}
